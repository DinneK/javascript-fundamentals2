...
describe("Magician", function () {
  ...
  it("should instantiate a Magician", function () {
  ...
  it("should have assistant info", function () {
  ...
  it("should have a favorite accessory by default", function () {
  ...
  it("should be able to perform a different trick", function () {
  ...
  it("should start with a little confidence", function () {
    var magician = new Magician({ name: "Leta" });

    assert.equal(magician.confidencePercentage, 10);
  });

  it("should be able to improve confidence with each trick", function () {
    var magician = new Magician({ name: "Leta" });
  ...
  it("should be able to perform a trick when cofidence is higher than 100", function () {
  ...
  it("should only be able to perform a trick if assistant is present", function () {
